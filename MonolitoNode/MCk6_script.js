...
export default function () {
  ...
  let regRes = http.post('http://localhost:3001/register', registerPayload, {
  ...
  let loginRes = http.post('http://localhost:3002/login', loginPayload, {
    headers: { 'Content-Type': 'application/json' }
  })
  ...
  let getRes = http.get('http://localhost:3003/profile', {
    headers: {
